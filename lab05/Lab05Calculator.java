 ...
 * @author dozdoga
 */
public class Lab05Calculator extends javax.swing.JFrame {

    /**
     * Creates new form Lab05Calculator
     */
    static double a=0, b=0, result=0;
    static int selection = 0;
    
    public Lab05Calculator() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("Derin Deniz Ozdogan");
...
jTextField1.setText(jTextField1.getText().concat("1"));        
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        System.out.println("Derin Deniz Ozdogan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lab05Calculator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Lab05Calculator().setVisible(true);
            }
        });
    }
